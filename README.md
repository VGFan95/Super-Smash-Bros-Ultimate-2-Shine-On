![Smash Ultimate 2 Shine On Logo](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/logo-transparent.png)
...
- Battle Assets
  ...
  - [Items](#items)
  - [Stages](#stages)
  - [Songs and Spirits](#songs-and-spirits)
- Battle Updates
  ...
  - Smash Meter
    ...
    - [Smash-Link](#smash-link)
  - [Ultimate Final Smash Attack](#ultimate-final-smash-attack)
  - [Final Smash Attack Power](#final-smash-attack-power)
  - [Custom Stage Music Playlist](#custom-stage-music-playlist)
  - [Cucco Keep-Away](#cucco-keep-away)
  - [Rules and Options](#rules-and-options)
- Challenge Modes
  - [Random Classic Mode Route](#random-classic-mode-route)
  - [All-Star Mode](#all-star-mode)
  - [Boss Rush Mode](#boss-rush-mode)
  - [All-Star Boss Rush](#all-star-boss-rush)
  - [World of Light](#world-of-light)
  - [Subspace Emissary Remaster](#subspace-emissary-remaster)
- Custom Content
  - [Break the Targets](#break-the-targets)
  - [Stage Builder Tools](#stage-builder-tools)
  - [Event Match Builder](#event-match-builder)
...
- Menu
  ...
  - [Game End Menu (Offline Smash)](#game-end-menu-offline-smash)
  - [Gallery Mode](#gallery-mode)
  - [Character Voice Language Select](#character-voice-language-select)
- Replay
  - [Replay Takeover](#replay-takeover)
  - [Delete All Replays](#delete-all-replays)
- Controls
  - [Button Mapping](#button-mapping)
  - [Controls: Sprint Button](#controls-sprint-button)
  - [Controls: Direction Lock Button](#controls-direction-lock-button)
  - [Control Option: Stick Flick Smash Attacks Toggle](control-option-stick-flick-smash-attacks-toggle)
  - [Easier Out of Shield](#easier-out-of-shield)
  - [Platform Drop During Dash](#platform-drop-during-dash)
  - [Auto Short Hop Special](#auto-short-hop-special)
  - [Controls Option: Auto Short Hop](#controls-option-auto-short-hop)
...
- Online
  ...
  - [Ratio Tag Team 3v3](#ratio-tag-team-3v3)
  - [Automatic Character Striking](#automatic-character-striking)
  - [Playlist of the Week](#playlist-of-the-week)
  - [Remote Friend](#remote-friend)
  - [Online Stage Music](#online-stage-music)
  - [Online Random Stage Select](#online-random-stage-select)
  - [Rematch Prevention](#rematch-prevention)
  - [Handling Disconnects](#handling-disconnects)
  - [Online Team Colors](#online-team-colors)
  - [Game End Menu (Online Quickplay)](#game-end-menu-online-quickplay)
  - [Item Enablement Choice](#item-enablement-choice)
  - [Battle Arena](#battle-arena)
  - [Wired Connection Preference](#wired-connection-preference)
  - [Rollback Netcode](#rollback-netcode)
  - [Networking HUD](#networking-hud)
- Fighter Updates
  - [Playable Fighter Moveset Changes](#playable-fighter-moveset-changes)
- Related Media
  - [Lite Edition](#lite-edition)
  - [Amiibo](#amiibo)
- DLC Notes
  - [DLC Schedule](#dlc-schedule)
  - [DLC Discounts](#dlc-discounts)
- Closing
...
![Returning Playable Fighters - Nintendo](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/returning-playable-fighters-nintendo.JPG)

Returning Playable Fighters - Guest:

![Returning Playable Fighters - Guest](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/returning-playable-fighters-guest.JPG)

Alternate Costume Playable Fighters:  
(not considered unique Playable Fighters. Any differences are purely aesthetic)

![Alternate Costume Playable Fighters](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/alternate-costume-playable-fighters.JPG)

New Playable Fighters - Nintendo:  
(Isaac, Toadette, Purah, and Nia are DLC)

![New Playable Fighters - Nintendo](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/new-playable-fighters-nintendo.JPG)
...
Each Playable Fighter in SSBU2 has a specific Assist Fighter assigned, known as a Partner. The "Partner" designation only has significance when certain rules options are being used. Otherwise, any Assist Trophy can spawn any Assist Fighter.

Partners - Nintendo:

![Partners - Nintendo](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/partners-nintendo.JPG)
...
| King of Fighters     | Terry                        | Rock Howard                   |
...
![Bosses - Nintendo](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/bosses-nintendo.JPG)

Bosses - Guest:

![Bosses - Guest](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/bosses-guest.JPG)
...
![Poké Ball Pokémon](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/poke-ball-pokemon.JPG)

Master Ball Pokémon:

![Poké Ball Pokémon - Master Ball](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/poke-ball-pokemon-master-ball.JPG)

## Items

SSBU2 has 55 items that can be used in various game modes.

![Items](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/items.JPG)
...
![Stages - Nintendo](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/stages-nintendo.JPG)

Returning Versus Stages - Guest:

![Stages - Guest](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/stages-guest.JPG)

New Versus Stages

![New Launch Stages](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/new-launch-stages.jpg)

DLC Versus Stages:

![DLC Stages](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/dlc-stages.jpg)

Boss Stages:

![Boss Stages](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/boss-stages.jpg)

## Songs and Spirits

New music tracks and Spirits have been added to SSBU2. Tracks and Spirits from games that came out before Ultimate as well as from games that came out after Ultimate have been included.

## Stage Types

Every versus stage in the game now has the following 12 forms:

- Normal Form, with [Hazards On](https://www.ssbwiki.com/Stage_hazard)
- Normal Form, with Hazards Off
- [Omega Form](https://www.ssbwiki.com/Ω_form)
- Omega Form, with Battlefield Platform Layout ([Battlefield Form](https://www.ssbwiki.com/Battlefield_form))
- Omega Form, with [Small Battlefield](https://www.ssbwiki.com/Small_Battlefield) Platform Layout (Small Battlefield Form)
- Omega Form, with Dynamic Platforms (Dynamic Battlefield Form)
- Big Omega Form
- Big Omega Form, with [Big Battlefield](https://www.ssbwiki.com/Big_Battlefield_(SSBU)) Platform Layout
- Big Omega Form, with [Pyrosphere](https://www.ssbwiki.com/Pyrosphere) Platform Layout
- Barrier Form
- Barrier Form, with Battlefield Platform Layout
- Barrier Form, with Small Battlefield Platform Layout

Dynamic Battlefield Form refers to a stage where the platforms gently change between Battlefield, Small Battlefield, and Omega layouts in a fixed order. Barrier Forms are like [King of Fighters Stadium](https://www.ssbwiki.com/King_of_Fighters_Stadium), where the stage has blast zone walls on the sides and no bottom blast zone.
...
At the start of Overtime, the [stage morphs](https://www.ssbwiki.com/Stage_Morph) into it’s Omega Form (or Barrier Form if a Barrier Form is currently being played). Bob-Ombs will begin to fall and spawn live on the ground after 10 seconds of Overtime have passed.
...
Each move in the game has an Offensive Meter Gain value that specifies the amount of Meter it builds for the Attacker and a Defensive Meter Gain value that specifies the amount of Meter it builds for the Defender. These values are not affected by move Staleness/Freshness. The Meter Gain value is multiplied by the appropriate multiplier for both the attacker and defender to determine how much Meter is built for each player. Each character also has a Defensive Meter Gain Multiplier, which may increase or decrease their defensive meter gain.
...
- In King of the Hill, having control of the Hill provides a slight amount of Meter each second

The Smash Meter is divided into 6 equal segments. Each segment requires 100 units of Meter to fill.
A player with a Full Smash Meter will lose a segment of Smash Meter if no segments are consumed within 15 seconds of the meter being filled.
...
If the Smash-Link button is being held down during the link-cancel window of an attack that is Smash-Linkable, that attack can cancel into another specific action. That action could be another attack, grab, jump, dash, air-dodge, tag-in, or a combination of those options.
...
A new editable, non-removable playlist called "My Custom Stage Music Playlist" now resides in the [Vault](https://www.ssbwiki.com/Vault) -> Playlists menu. This allows players to create a playlist of songs that can be played on any stage. Music tracks from any series can be put into this playlist.
...
- Shy Guys, Koopas, Paratroopas, Goombas, Bullet Bill Launchers, and Podoboos can be set as Enemies on the course. They can be set to have a respawn delay or not to respawn.
...
| Cannot Pick Up Items When Leading      | Causes the character to be unable to pick up items when they are in the lead                                                                                                                    |
...
| Underdog Boost                         | Causes the character to get a boost to Damage Dealt and Knockback Dealt and to receive less damage and knockback when far behind in Score. Has a chance to give the player a Final Smash or item|
...
This [Ken Strings](https://www.youtube.com/watch?v=qpfd0fGQGW4) video is a great example of what this mode would be capable of.
...
A Tutorial Mode is available, where the player plays as Mario and covers the basics of how to play the game and various controls options. Provides a breif overview of the topics discussed in both Vault → How to Play and Core-A-Gaming's [Why Button Mashing Doesn’t Work](https://www.youtube.com/watch?v=_R0hbe8HZj0) video.
...
When watching a replay, the last 10 seconds of the gamestate watched is stored in memory, allowing the player to pause the replay and choose to take control of a character as if it was a live match at any point of the saved gamestate. Characters not controlled by a player will perform their inputs from the replay.
...
Stick Flick Smash Attacks can be enabled or disabled.
When disabled, the player cannot get a Smash Attack with a stick flick. The Attack+Special (A+B) setting must be used.
...
Tag-In can be used while shielding, bypassing the Shield-Drop animation.
...
The [Auto Short-Hop](https://www.ssbwiki.com/Short_hop#Mechanics) option has three values it can be set to:
...
| Stock Count: 3                                         | Stock Count: 3                                                     |
| Time Limit: 4:00                                       | Time Limit: 4:00                                                   |
| Smash Meter: Disabled                                  | Smash Meter: Disabled                                              |
...
- Seperate Stock Behavior Tag Team 3v3 (King of the Hill - 1v1)
- Seperate Stock Behavior Ratio Tag Team 3v3 (King of the Hill) (Uses same Ratio Sheet currently in use for the normal Ratio Tag Team quickplay playlist)
...
SSBU2 implements [Rollback Netcode](https://words.infil.net/w02-netcode.html) for a smoother online experience.
...
Here is the list of Playable Fighter specific changes made in the transition to SSBU2:
(Smash-Links and updates to Final Smash Attacks / Ultimate Final Smash Attacks not listed)
...
|                  | • Reduced the number of intangibility frames during the endlag of Final Smash Attacks                                                                                    |
...
|                  | • The Command Selection moves now show a uniqe icon per move next to the mana cost of each item                                                                          |
...
![Lite Edition Fighters](https://github.com/VGFan95/Super-Smash-Bros-Ultimate-2-Shine-On/blob/main/images/lite-edition-fighters.jpg)
...
DLC releases begin 3 months after the launch of the game. Each quarter (3 months) has the following set DLC cycle:

- Month 1: DLC Playable Fighter (with any bundled content)
- Month 2: DLC Assist Fighter (with any bundled content)
- Month 3: Misc DLC (Character Colors, Character Alternate Outfits, Mii Fighter Costumes, Online Nameplates and Profile Images, etc)
...
- Battle Assets
  - Playable Fighters: 100 Playable Fighters is a tremendous achievement for the game! The 75% Nintendo 25% Guest split is fun. Beyond 100 Playable Fighters is probably too many Playable Fighters and beyond 25% Guest Playable Fighhters is probably too many Guest Playable Fighters. I love all these characters and know they will greatly boost sales and interest in the game. 4 New characters at launch is great and 12 more over three years keeps the game hyped for a long period of time post-launch.
  - Assist Fighters: A great way to let more characters into the game and be visible in battle without having to go over the 100 Playable Fighters limit. Players will also love seeing these characters on stage!
  - Bosses: Smash has incredible Boss Battles. The team really knows how to make them fun and exciting, so the number of bosses has been cranked way up. 33 was chosen since the idea for the All-Star Boss Rush mode came before the bosses were decided.
  - Pokemon: A mix of new and returning Poke-ball & Master-ball Pokemon. Some tough, some cute, all fun!
...
- Controls
  ...
  - Button Mapping: New Defaults: The updated default controls for the game. They are different than previous games, but I believe them to be the best to learn. If you've never tried a controller with back paddles, it really is a game changer. The Xbox Elite Series 2 really is the best pad on the market. There will be several other presets built in to the game, for quick changing layouts.
- Online
  ...
  - Online Stage Music: A quality of life feature to listen to more of the games' soundtrack during online play and only get tracks you want
